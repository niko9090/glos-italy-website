// Sections With Dividers - Renders sections with automatic dividers between them
'use client'
...
export function SectionsWithDividers({ sections, products }: SectionsWithDividersProps) {
