    ...
    const mutations = [
      {
        patch: {
          ...
          set: {
            ...
            [`sections[${ctaSectionIndex}].size`]: 'md',
            [`sections[${ctaSectionIndex}].fullWidth`]: true,
            [`sections[${ctaSectionIndex}].contentWidth`]: 'normal',
            [`sections[${ctaSectionIndex}].paddingTop`]: 'md',
            [`sections[${ctaSectionIndex}].paddingBottom`]: 'md',
            [`sections[${ctaSectionIndex}].titleSize`]: 'normal',
